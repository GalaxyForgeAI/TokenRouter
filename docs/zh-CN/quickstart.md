...
| 想做什么 | 文档 |
|---|---|
| 完整部署（PostgreSQL、反向代理、环境变量） | [部署指南](deployment.md) |
| 三种角色的完整操作手册 | [用户指南](user-guide.md) / [团队负责人指南](team-leader-guide.md) / [管理员指南](administrator-guide.md) |
| 接入 Codex 订阅账号 | [Codex 接入指南](codex-tokenhub-profile-quick-start.md) |
| 架构与数据流 | [架构说明](architecture.md) |
